...
greaterThan(QT_MAJOR_VERSION, 5) {
    # Qt6: additional modules that still ship translations
    exists($$[QT_INSTALL_TRANSLATIONS]/qtscript_ru.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtscript_ru.qm
    exists($$[QT_INSTALL_TRANSLATIONS]/qtquick1_ru.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtquick1_ru.qm
    exists($$[QT_INSTALL_TRANSLATIONS]/qtmultimedia_ru.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtmultimedia_ru.qm
    exists($$[QT_INSTALL_TRANSLATIONS]/qtxmlpatterns_ru.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtxmlpatterns_ru.qm
    exists($$[QT_INSTALL_TRANSLATIONS]/qtscript_uk.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtscript_uk.qm
    exists($$[QT_INSTALL_TRANSLATIONS]/qtquick1_uk.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtquick1_uk.qm
    exists($$[QT_INSTALL_TRANSLATIONS]/qtmultimedia_uk.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtmultimedia_uk.qm
    exists($$[QT_INSTALL_TRANSLATIONS]/qtxmlpatterns_uk.qm): QT_QM += $$[QT_INSTALL_TRANSLATIONS]/qtxmlpatterns_uk.qm
}
