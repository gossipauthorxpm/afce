...
//  QToolButton *tbCase;
  ...
  QToolButton *tbData;
  QToolButton *tbStoredData;
  QToolButton *tbDocument;
  QToolButton *tbManualInput;
  QToolButton *tbDisplay;
  QToolButton *tbManualOp;
  QToolButton *tbParallel;
  QToolButton *tbConnector;
  QToolButton *tbEllipsis;
  QToolButton *tbRam;
  QToolButton *tbSeqAccess;
  QToolButton *tbDirectAccess;
  QToolButton *tbCard;
  QToolButton *tbPaperTape;
...
public slots:
  ...
  void slotFilePrint();
  void slotImportCSource();
  void slotImportPseudoLang();
  void slotEditCopy();
  void slotEditCut();
  void slotEditPaste();
  void slotEditDelete();
  ...
  void slotToolAssign();
  void slotToolData();
  void slotToolStoredData();
  void slotToolDocument();
  void slotToolManualInput();
  void slotToolDisplay();
  void slotToolManualOp();
  void slotToolParallel();
  void slotToolConnector();
  void slotToolEllipsis();
  void slotToolRam();
  void slotToolSeqAccess();
  void slotToolDirectAccess();
  void slotToolCard();
  void slotToolPaperTape();
